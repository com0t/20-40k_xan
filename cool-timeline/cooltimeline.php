...
if (!defined('COOL_TIMELINE_CURRENT_VERSION')){
	define('COOL_TIMELINE_CURRENT_VERSION', '2.3.2');
}
	...
	*/
	public function ctl_include_files(){			
		...
		if(is_admin()){
			...
			$PostType = CTL_functions::ctlfree_get_ctp();
			//if($PostType=="cool_timeline"){
				require_once COOL_TIMELINE_PLUGIN_DIR . 'admin/ctl-framework/ctl-framework.php';
			...
			require_once COOL_TIMELINE_PLUGIN_DIR . 'admin/notices/plugin-upgrade-notice.php';
