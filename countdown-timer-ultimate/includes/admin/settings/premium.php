...
<div class="wrap">
	...
	<h2><?php _e( 'Countdown Timer Ultimate with', 'countdown-timer-ultimate' ); ?><span class="wpos-epb"><?php _e( 'Essential Plugin Bundle', 'countdown-timer-ultimate' ); ?></span></h2><br />
				...
				<table class="wpos-plugin-pricing-table">
					...
					<colgroup></colgroup>	
						...
						<tr>
							...
							<th>
								...
								<p>Gain access to <strong>Countdown Timer Ultimate</strong> included in <br /><strong class="wpos-epb">Essential Plugin Bundle</strong></p>
								<a href="<?php echo WPCDT_SITE_LINK; ?>/pricing/?utm_source=WP&utm_medium=Countdown-Timer&utm_campaign=Upgrade-PRO" class="wpos-button" target="_blank">Buy Now</a>
							</th>	    		
						</tr>
					</thead>
					...
					<tfoot>
						<tr>
							<th></th>
							<td></td>
							<td><p>Gain access to <strong>Countdown Timer Ultimate</strong> included in <strong>Essential Plugin Bundle</strong></p>
							<a href="<?php echo WPCDT_SITE_LINK; ?>/pricing/?utm_source=WP&utm_medium=Countdown-Timer&utm_campaign=Upgrade-PRO" class="wpos-button" target="_blank">Buy Now</a></td>
						</tr>
					</tfoot>
				...
				<!--Upgrad to Pro HTML -->
					<div id="postbox-container-1" class="postbox-container wpos-sidebar">
						<div class="wpos-epb-wrap">
							...
							<ul>
								<li><b>40+ Utility Plugins</b> including <span><?php echo WPCDT_NAME; ?> premium </span> version.</li>
							...
							<a class="button-yellow button-orange" style="margin-bottom:0px;" href="<?php echo WPCDT_SITE_LINK; ?>/essential-bundle/?utm_source=WP&utm_medium=Countdown&utm_campaign=EPB-Upgrade-PRO" target="_blank">Buy Now</a>
						</div>
