...
if( ! defined( 'WPCDT_VERSION' ) ) {
	define( 'WPCDT_VERSION', '2.0.3' ); // Version of plugin
}
...
if( ! defined( 'WPCDT_PRO_LINK' ) ) {
	define( 'WPCDT_PRO_LINK', 'https://www.essentialplugin.com/pricing/?utm_source=WP&utm_medium=Countdown&utm_campaign=Features-PRO' ); // Pro Plugin link
}
...
if ( is_admin() || ( defined( 'WP_CLI' ) && WP_CLI ) ) {
	...
	if( version_compare( $plugin_version, '1.1' ) < 0 ) {
		require_once( WPCDT_DIR . '/includes/admin/wpcdt-db-upgrade.php' );
	}
